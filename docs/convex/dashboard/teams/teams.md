...
In Convex, your projects are organized by team. Teams are used to share access to your projects with other people. To switch between teams or create a new team, click your team's name at the top of the Convex dashboard. Inside a project, the same menu is behind your team's icon, to the left of the project name.

![Team switcher](/screenshots/storybook/pages_projects_team_switcher_light.webp)

The menu lists every team you belong to, and typing filters it. Pressing `/` or `⌘K` (`Ctrl+K` on Windows and Linux) anywhere in the dashboard opens the command palette, which has the same **Switch Team** menu alongside search across your projects and deployments.
...
## Team Authentication[​](#team-authentication "Direct link to Team Authentication")

info

Single Sign-On and Directory Sync are only available on Convex Business and Enterprise.

The [team authentication page](https://dashboard.convex.dev/team/settings/team-authentication) is where you verify the email domains your team owns and connect your organization's identity provider:

* **[Single Sign-On (SSO)](/team-management/sso.md)** lets team members authenticate through your identity provider.
* **[Directory Sync (SCIM)](/team-management/directory-sync.md)** provisions members and their roles from your identity provider's user directory.

![Team authentication page](/screenshots/storybook/pages_team_authentication_light.webp)
