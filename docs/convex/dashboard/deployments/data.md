...
![Data Dashboard Page](/screenshots/storybook/pages_project_deployment_data_light.webp)
...
A readonly view of the data page is available in the [command line](/cli/reference/data.md).
...
![Data filters](/screenshots/storybook/pages_project_deployment_data_filters_light.webp)
...
![Custom query button](/screenshots/storybook/pages_project_deployment_data_custom_query_light.webp)
...
![Running a custom test query](/screenshots/storybook/pages_project_deployment_data_custom_query_runner_light.webp)
...
![Add document](/screenshots/storybook/pages_project_deployment_data_add_document_light.webp)
...
![Quick actions context menu](/screenshots/storybook/pages_project_deployment_data_context_menu_light.webp)
...
![Inline value editor](/screenshots/storybook/pages_project_deployment_data_edit_inline_light.webp)
...
![Edit entire document](/screenshots/storybook/pages_project_deployment_data_edit_document_light.webp)
...
![Bulk edit documents](/screenshots/storybook/pages_project_deployment_data_bulk_edit_light.webp)
...
To see the [schema](/database/schemas.md) of your whole deployment, including the relationships between tables, use the [Schema page](/dashboard/deployments/schema.md).
