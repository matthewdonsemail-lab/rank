...
Upgrade to optimize your bundle

Starting from version 1.31.5, the `convex` NPM package includes optimizations to the sourcemaps in your bundle, which can substantially reduce bundle size. Upgrade to the latest version of the `convex` package for these improvements.
