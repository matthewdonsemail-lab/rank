...
This page explains why. For the how, see [SvelteKit Server Rendering](/client/svelte/sveltekit-server-rendering.md).

## The client-side waterfall[​](#the-client-side-waterfall "Direct link to The client-side waterfall")
...
## SSR eliminates the waterfall[​](#ssr-eliminates-the-waterfall "Direct link to SSR eliminates the waterfall")
...
## How much faster?[​](#how-much-faster "Direct link to How much faster?")
...
## Co-locate your server with Convex[​](#co-locate-your-server-with-convex "Direct link to Co-locate your server with Convex")
...
## SSR is easy with the SvelteKit transport hook[​](#ssr-is-easy-with-the-sveltekit-transport-hook "Direct link to SSR is easy with the SvelteKit transport hook")

A common concern is that SSR adds boilerplate. With the [`convexLoad` transport hook](/client/svelte/sveltekit-server-rendering.md#ssr-with-convexload--convexloadpaginated-recommended), it's minimal — fetch in your load function, use the result directly in the template. No manual `initialData` wiring needed:
...
## When is client-side rendering acceptable?[​](#when-is-client-side-rendering-acceptable "Direct link to When is client-side rendering acceptable?")
