...
These examples use the [Convex AI Gateway](/ai-gateway/overview.md). See [Getting Started](/agents/getting-started.md) for installation and requirements.
...
const sharedDefaults = {
  ...
  embeddingModel: convexGateway.embeddingModel("openai/text-embedding-3-small"),
