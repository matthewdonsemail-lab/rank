...
[values/validators.ts:126](https://github.com/get-convex/convex-js/blob/main/src/values/validators.ts#L126)

## Methods[​](#methods "Direct link to Methods")

### optional[​](#optional "Direct link to optional")

▸ **optional**(): [`VFloat64`](/api/classes/values.VFloat64.md)<`undefined` | `Type`, `"optional"`>

Allow this field to be validated as absent.

#### Returns[​](#returns "Direct link to Returns")

[`VFloat64`](/api/classes/values.VFloat64.md)<`undefined` | `Type`, `"optional"`>
...
[values/validators.ts:134](https://github.com/get-convex/convex-js/blob/main/src/values/validators.ts#L134)
