...
[values/validators.ts:210](https://github.com/get-convex/convex-js/blob/main/src/values/validators.ts#L210)

## Methods[​](#methods "Direct link to Methods")

### optional[​](#optional "Direct link to optional")

▸ **optional**(): [`VBoolean`](/api/classes/values.VBoolean.md)<`undefined` | `Type`, `"optional"`>

Allow this validated field to be absent.

#### Returns[​](#returns "Direct link to Returns")

[`VBoolean`](/api/classes/values.VBoolean.md)<`undefined` | `Type`, `"optional"`>
...
[values/validators.ts:217](https://github.com/get-convex/convex-js/blob/main/src/values/validators.ts#L217)
