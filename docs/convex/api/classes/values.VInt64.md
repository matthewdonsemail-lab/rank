...
[values/validators.ts:155](https://github.com/get-convex/convex-js/blob/main/src/values/validators.ts#L155)

## Methods[​](#methods "Direct link to Methods")

### optional[​](#optional "Direct link to optional")

▸ **optional**(): [`VInt64`](/api/classes/values.VInt64.md)<`undefined` | `Type`, `"optional"`>

Allow this validated field to be absent.

#### Returns[​](#returns "Direct link to Returns")

[`VInt64`](/api/classes/values.VInt64.md)<`undefined` | `Type`, `"optional"`>
...
[values/validators.ts:163](https://github.com/get-convex/convex-js/blob/main/src/values/validators.ts#L163)
