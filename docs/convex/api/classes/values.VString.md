...
[values/validators.ts:264](https://github.com/get-convex/convex-js/blob/main/src/values/validators.ts#L264)

## Methods[​](#methods "Direct link to Methods")

### optional[​](#optional "Direct link to optional")

▸ **optional**(): [`VString`](/api/classes/values.VString.md)<`undefined` | `Type`, `"optional"`>

Allow this validated field to be absent.

#### Returns[​](#returns "Direct link to Returns")

[`VString`](/api/classes/values.VString.md)<`undefined` | `Type`, `"optional"`>
...
[values/validators.ts:271](https://github.com/get-convex/convex-js/blob/main/src/values/validators.ts#L271)
