...
[values/validators.ts:182](https://github.com/get-convex/convex-js/blob/main/src/values/validators.ts#L182)

## Methods[​](#methods "Direct link to Methods")

### optional[​](#optional "Direct link to optional")

▸ **optional**(): [`VCommitTs`](/api/classes/values.VCommitTs.md)<`undefined` | `Type`, `"optional"`>

Allow this validated field to be absent.

#### Returns[​](#returns "Direct link to Returns")

[`VCommitTs`](/api/classes/values.VCommitTs.md)<`undefined` | `Type`, `"optional"`>
...
[values/validators.ts:189](https://github.com/get-convex/convex-js/blob/main/src/values/validators.ts#L189)
