...
▸ **optional**(): [`VBytes`](/api/classes/values.VBytes.md)<`undefined` | `Type`, `"optional"`>

Allow this validated field to be absent.

#### Returns[​](#returns "Direct link to Returns")

[`VBytes`](/api/classes/values.VBytes.md)<`undefined` | `Type`, `"optional"`>
...
[values/validators.ts:245](https://github.com/get-convex/convex-js/blob/main/src/values/validators.ts#L245)
