...
The good news is Convex is always typed. It's just implicitly typed! When you submit a document to Convex, tracks all the types of all the fields in your document. You can go to your [dashboard](/dashboard/overview.md) and view the inferred schema of any table to understand what you've ended up with.
