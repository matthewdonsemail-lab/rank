...
This page explains what the plugins do, how to install them, how to get the most out of them, and how to send us feedback. For agent-specific setup, see the dedicated pages for [Claude Code](/ai/using-claude-code.md), [Codex](/ai/using-codex.md), and [Cursor](/ai/using-cursor.md).

## What the plugin does[​](#what-the-plugin-does "Direct link to What the plugin does")

Every Convex plugin bundles three kinds of help:

* **Tools**: a built-in [Convex MCP server](/ai/convex-mcp-server.md) that lets the agent securely interact with your dev deployment. It can read your data, logs, and insights, and run functions, so the agent works from what your deployment actually contains instead of guessing.
...
For the newest build straight from Convex, see the [nightly marketplace install](/ai/using-codex.md#install-the-convex-plugin).
...
## Using the plugins effectively[​](#using-the-plugins-effectively "Direct link to Using the plugins effectively")
