...
TypeScript 7.0 does not include a JavaScript API, so if other tools in your project import it, follow TypeScript's [side-by-side installation](https://devblogs.microsoft.com/typescript/announcing-typescript-7-0/#running-side-by-side-with-typescript-6.0) instructions. Convex picks up TypeScript 7 in that setup too.
